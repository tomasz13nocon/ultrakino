angular.module("app")
.controller("FilmsController", ['$animate', '$http', '$location', '$rootScope', '$scope', '$timeout', '$window', 'Film', function($animate, $http, $location, $rootScope, $scope, $timeout, $window, Film) {
	var ctrl = this;
		...
		if (params.categories) {
			for (category in params.categories) {
				if (params.categories[category])
					p.categories.push($rootScope.filmCategoriesIds[category]);
			}
		}
